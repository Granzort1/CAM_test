...
class Window(QWidget):
    ...
    def initUI(self):
        ...
        # 버튼과 진행바 선택 widget
        grid1.addWidget(self.createButtonGroup(), 3, 0, 1, 1)

        # 진행상활 알려주는 창 widget
        grid1.addWidget(self.createExplainGroup(), 1, 1, 3, 1)
    ...
    def createButtonGroup(self):
        ...
        guideText3 = "위 매체와 시간 선택 옵션을 선택하고\n지도 보기를 선택하세요." 
        labelExp3 = QLabel(guideText3, self)

        searchButton = QPushButton('모형 결과 지도 보기', self)         # button
    ...
    def view_results_on_map(self, media, interval):
        ...
        for i in range(0, map_frames):
            ...
            # Color - Multi-hue: BuPu, YlGn, PuRd, OrRd, YlGnBu
            myscale = (geo_conc['conc'].quantile((0,0.1,0.2,0.9,0.98,1))).tolist()
            ...
            choropleth = folium.Choropleth(
                ...
                line_weight=0,
                smooth_factor=0,
                legend_name=f'{media_k} 중 농도(ug/ml)',
